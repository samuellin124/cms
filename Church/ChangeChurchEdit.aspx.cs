...
public partial class Church_ChangeChurchEdit : BasePage
{
    ...
    private string GetRptHead()
    {
        string retStr = "";
        retStr += "<head>";
        retStr += "<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">";
        retStr += "<title>轉介單</title>";
        retStr += "<style>";
        retStr += "<!--";
        retStr += "div.Section1";
	    retStr += "{page:Section1;}";
        retStr += "p.MsoNormal";
        retStr += "	{margin:0cm;";
	    retStr += "margin-bottom:.0001pt;";
	    retStr += "font-size:12.0pt;";
	    retStr += "font-family:\"Times New Roman\";}";
        retStr += "-->";
        retStr += "</style>";
        retStr += "</head>";
        retStr += "<body>";
        ...
        retStr += "\t<tr>";
        retStr += "\t\t<td style=\"text-align:center;font-size:24px;font-family:標楷體;border-style:none;font-weight:bold;\" colspan=\"8\">好消息家庭關懷專線個案轉介&nbsp;</td>";
        retStr += "\t</tr>";
        retStr += "</table>";
        return retStr;
...
//</table>
    ...
    protected void btnChange_Click(object sender, EventArgs e)
    {
        ...
        context = GetRptHead() + GetReport() + "</body></html>";
