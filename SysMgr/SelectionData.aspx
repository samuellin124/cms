<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectionData.aspx.cs" Inherits="SysMgr_SelectionData" %>
...
<body class="body">
    ...
    <table width="100%" class="table_v">
        <tr>
            <th align="right" width="15%">選項群組：</th>
            <td width="20%" align="left">
                <asp:DropDownList ID="ddlGroupName" runat="server" AutoPostBack="False" >
                </asp:DropDownList>
             </td>
             <th width="15%" align="right">選項名稱：</th>
             <td width="20%" align="left">
                 <asp:TextBox runat="server" ID="txtCaseName" Width="60mm" CssClass="font9"></asp:TextBox>
             </td>
