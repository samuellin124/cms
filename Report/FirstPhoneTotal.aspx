<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="FirstPhoneTotal.aspx.cs" Inherits="FirstPhone" %>
...
<body class="body" >
    ...
    <h1>
        ...
        <asp:Literal ID="litTitle" runat="server" Text="第一次來電數統計表 "></asp:Literal>
    </h1>
