...
<body class="body">
    <form id="Form1" name="form" runat="server">
        ...
        <h1>
            ...
            <asp:Label ID="lblTitle" runat="server" Text="來電類別統計"></asp:Label>
        ...
        <td width="100%" class="table_v">
            <tr>
                ...
                <td width="10%" align="center">
                    <asp:DropDownList ID="ddlQuerter" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlQuerter_SelectedIndexChanged"></asp:DropDownList>
                </td>
                <th align="right" width="10%">查詢日期：
                </th>
                <td width="30%">
            ...
            <tr>
                <td class="auto-style4" colspan="20">
                    <asp:Chart ID="Chart1" runat="server" BackColor="WhiteSmoke" Height="1000px" Width="1100px" BorderlineDashStyle="Solid" BackSecondaryColor="White" BackGradientStyle="TopBottom" BorderWidth="2px" BorderColor="#1A3B69" ImageLocation="~/TempImages/ChartPic_#SEQ(300,3)">
                        <Titles>
                            <asp:Title runat="server" ShadowColor="32, 0, 0, 0" Font="Arial Unicode MS, 14.25pt, style=Bold" ShadowOffset="3" Text="關懷來電年度統計" Name="Title1" ForeColor="26, 59, 105"></asp:Title>
                        </Titles>
                        <Legends>
                            <%--圖利字型--%>
