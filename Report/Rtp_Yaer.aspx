<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="Rtp_Yaer.aspx.cs" Inherits="Rtp_Yaer" %>
...
<body class="body" >
    ...
    <h1>
        ...
        <asp:Literal ID="litTitle" runat="server" Text="年度統計"></asp:Literal>
    </h1>
        ...
        <tr>
            ...
            <td width="15%" align="center">
                <asp:DropDownList ID="ddlYear" runat="server"></asp:DropDownList>
                  ...
                  <td  colspan ="3" align="left" width="15%">
                ...
                onclick="btnPrint_Click" /> --%>
                   <asp:Button ID="btnAllQuery" class="npoButton npoButton_Search" runat="server"
                    Text="年度統計" OnClick="btnAllQuery_Click"/>
            </td>
        </tr>
       <tr>
            <td width="100%" colspan="6">
                ...
                <asp:Label ID="lblAllyear" runat="server"></asp:Label>
