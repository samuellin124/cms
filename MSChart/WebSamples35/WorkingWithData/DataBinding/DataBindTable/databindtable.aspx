	...
	<body>
		<form id="ImageMapCustom" method="post" runat="server">
			...
			<table class="sampleTable">
				<tr>
					<td class="tdchart"><asp:chart id="Chart1" runat="server" BackColor="#D3DFF0" Width="412px" Height="296px" BorderColor="26, 59, 105" Palette="BrightPastel" BorderDashStyle="Solid" BackGradientStyle="TopBottom" BackSecondaryColor="White" BorderWidth="2" imagetype="Png" ImageLocation="~\TempImages\ChartPic_#SEQ(300,3)">
							<titles>
