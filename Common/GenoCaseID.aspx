<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GenoCaseID.aspx.cs" Inherits="Common_GenoCaseID" ValidateRequest="false" %>
...
<body class="body">
    <form name="genoPanel" id="genoPanel" runat="server">
        ...
        <asp:HiddenField runat="server" ID="HFD_CaseID" />
        <asp:HiddenField runat="server" ID="HFD_EvaluateID" />
