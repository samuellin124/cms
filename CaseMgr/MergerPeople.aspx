<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MergerPeople.aspx.cs" Inherits="CaseMgr_MergerPeople" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //AddTemplateDetail
        function AddPeople(tType) {
            var PeopleUID = $('#HFD_PeopleUID').getValue();
            window.open("MargerPeopleDetail_Edit.aspx?Mode=People&PeopleUID=" + PeopleUID,
            "AddPeople",
            "help=no,status=no,resizable=yes,scrollbars=yes,center=yes,width=700px,height=500px");
        }
        function AddMain(tType) {
            var PeopleUID = $('#HFD_PeopleUID').getValue();
            window.open("MargerPeopleDetail_Edit.aspx?Mode=Main&PeopleUID=" + PeopleUID,
            "AddPeople",
            "help=no,status=no,resizable=yes,scrollbars=yes,center=yes,width=700px,height=500px");
        }
        ...
        //--------------------------------------------------------------------------
        function LoadMargerPeople() {
            var PeopleUID = $('#HFD_PeopleUID').getValue();
            
            $.ajax({
                type: 'post',
                url: "../common/ajax.aspx",
                data: 'Type=LoadMargerPeople' + '&PeopleUID=' + PeopleUID,
                async: false,
                success: function (result) {
                    $('#lblPeople').html(result);
                },
                error: function () { alert('LoadMargerPeople() failed'); }
            })
        }
        //--------------------------------------------------------------------------
    </script>
...
<body class="body" >
    ...
    <asp:HiddenField ID="HFD_PeopleUID" runat="server" />
    <asp:HiddenField ID="HFD_Main" runat="server" />
    <asp:HiddenField ID="HFD_Merger" runat="server" />
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
       <%-- <tr>
        ...
        <tr>
         ...
         <tr>
            <td align="center" colspan="6" style="background-color: Gray; color: White; font-weight: bold">
               主要人員
            </td>
        </tr>
        <tr>
            <td width="100%" colspan="6">
                    <asp:Button ID="Button1" class="npoButton npoButton_New" runat="server" Text="主要人員"
                    Width="35mm" OnClientClick="AddMain(); return false;" />
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
        ...
        <tr>
            <td width="100%" colspan="6">
                <asp:Button ID="btnAddPeople" class="npoButton npoButton_New" runat="server" Text="新增要被合併的人員"
                    Width="50mm" OnClientClick="AddPeople(); return false;" />
   ...
   <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
     <tr>
     <td  align="center">
     <asp:Button ID="btnSave" runat="server"  Text="合併" class="npoButton npoButton_Save" 
             OnClientClick="if (!confirm('一經合併無法復原，確認合併?')) return false;" 
