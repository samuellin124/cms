...
public partial class CaseMgr_ServiceRecordEdit : BasePage
{
    ...
    private void LoadFormData()
    {
        ...
        if (HFD_Mode.Value == "Edit")
        {
            ...
            //服務日期
            txtServiceData.Text = Util.DateTime2String(dr["ServiceData"], DateType.yyyyMMdd, EmptyType.ReturnNull);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        Session["Msg"] = "新增資料成功";
        Response.Redirect(Util.RedirectByTime("ServiceRecordQry.aspx"));
    ...
    private DataTable GetDataTable()
    {
        //讀取資料庫
        string strSql = @"
                        select r.UserID as UserID,r.ClassUid as ClassUid,r.ItemUid as ItemUid , r.ServiceData as ServiceData,r.uid as uid,a.UserName as 志工 ,c.ClassName as 服務類別 ,i.ItemName as 服務項目 ,i.Score as 分數 
                        from ServiceRecord as r 
                        inner join AdminUser a on a.UserID = r.UserID
                        inner join ServiceClass c on c.uid = r.ClassUid
                        inner join ServiceItem i on i.uid = r.ItemUid
