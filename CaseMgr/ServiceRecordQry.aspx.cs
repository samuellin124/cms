...
public partial class CaseMgr_ServiceRecordQry : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Session["ProgID"] = "ServiceRecordQry";
        //權控處理
        AuthrityControl();
        //有 npoGridView 時才需要
    ...
    private void SetColumnData(List<ColumnData> list)
    {
        ...
        //服務日期
        list.Add(new ColumnData("ServiceData", Util.DateTime2String(txtServiceData.Text, DateType.yyyyMMdd, EmptyType.ReturnNull), true, true, false));
    }
    //--------------------------------------------------------------------------------------
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        //SetColumnData(list);
        //string strSql = Util.CreateInsertCommand("ServiceRecord", list, dict);
        //NpoDB.ExecuteSQLS(strSql, dict);
        //Session["Msg"] = "新增資料成功";
        Response.Redirect(Util.RedirectByTime("ServiceRecordEdit.aspx"));
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        //List<ColumnData> list = new List<ColumnData>();
        //SetColumnData(list);
        //string strSql = Util.CreateUpdateCommand("ServiceRecord", list, dict);
        //NpoDB.ExecuteSQLS(strSql, dict);
        //Session["Msg"] = "修改資料成功";
        Response.Redirect(Util.RedirectByTime("ServiceRecordEdit.aspx"));
    }
...
//        Session["Msg"] = "刪除資料成功";
    ...
    {
        Response.Redirect("ServiceRecordQry.aspx");
    }
    // 報表************************************************************************************************************************
    ...
    public void LoadDropDownListData()
    {
        ...
        //服務類別
        strSql = "select uid , ClassName from ServiceClass";
    ...
    private DataTable GetDataTable()
    {
        //讀取資料庫
        string strSql = @"
                        select r.UserID as UserID,r.ClassUid as ClassUid,r.ItemUid as ItemUid , r.ServiceData as ServiceData,r.uid as uid,a.UserName as 志工 
                        ,c.ClassName as 服務類別 ,i.ItemName as 服務項目 ,CONVERT(varchar(10),r.ServiceData,111) as 服務日期,i.Score as 分數 
                        from ServiceRecord as r 
                        inner join AdminUser a on a.UserID = r.UserID
                        inner join ServiceClass c on (c.uid = r.ClassUid and isnull(c.IsDelete,'')<>'Y')
                        inner join ServiceItem i on (i.uid = r.ItemUid and isnull(i.IsDelete,'')<>'Y')
                        where isnull(r.IsDelete, '') != 'Y'
                        ";
    ...
    {
        //服務項目
        string strSql = "select uid ,ItemName from ServiceItem  where ClassUid ='" + ddlClassUid.SelectedValue + "' and isnull(IsDelete, '') != 'Y' ";
        Util.FillDropDownList(ddlItemUid, strSql, "ItemName", "uid", true);
    }
}
