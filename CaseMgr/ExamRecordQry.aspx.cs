...
public partial class CaseMgr_ExamRecordQry : BasePage
{
    ...
    private void LoadFormData()
    {
        ...
        npoGridView.EditLink = Util.RedirectByTime("ExamRecordEdit.aspx", "UID=");
        lblGridList.Text = npoGridView.Render();
    }
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        Response.Redirect(Util.RedirectByTime("ExamRecordEdit.aspx?Mode=ADD&"));
    }
    ...
    private DataTable GetDataTable()
    {
        //讀取資料庫
        string strSql = @"
                       select e.uid as uid,u.UserID as 員工編號,UserName as 志工姓名 
                       from ExamRecord e
                       inner join AdminUser u on u.uid =e.UserID
                       where 1=1
                        ";
        if (txtName.Text != "")
        {
