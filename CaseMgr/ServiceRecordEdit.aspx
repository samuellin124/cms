<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ServiceRecordEdit.aspx.cs"
    Inherits="CaseMgr_ServiceRecordEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initCalendar() {
            Calendar.setup({
                inputField: "txtServiceData",   // id of the input field
                button: "imgServiceData"     // 與觸發動作的物件ID相同
...
<body class="body">
    <form id="Form1" runat="server" submitdisabledcontrols="False">
        ...
        <h1>
            <img src="../images/h1_arr.gif" alt="" width="10" height="10" />好消息熱線中心志願服務紀錄表</h1>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
            ...
            <tr>
                ...
                <tr>
                <th align="right" width="12%">服務日期：
                </th>
                <td align="left" width="10%">
                    <asp:TextBox ID="txtServiceData" CssClass="font9" Width="28mm" runat="server" onchange="CheckDateFormat(this, '日期');"></asp:TextBox>
                    <img id="imgServiceData" alt="" src="../images/date.gif" />
                </td>
            </tr>
            <tr>
                <td align="right" width="30%" colspan="8">
