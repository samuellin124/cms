<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ServiceClassEdit.aspx.cs"
    Inherits="CaseMgr_ServiceClassEdit" %>
...
<body class="body">
    <form id="Form1" runat="server" submitdisabledcontrols="False">
        ...
        <asp:HiddenField ID="HFD_ServiceClassUID" runat="server" />
        <asp:Label runat="server" ID="Toolbar"></asp:Label>
        <h1>
            <img src="../images/h1_arr.gif" alt="" width="10" height="10" />
            <asp:Literal ID="litTitle" runat="server" Text="服務類別管理"></asp:Literal>
        </h1>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">
            <tr>
                <th align="right" style="width: 40mm">服務類別：
                </th>
                <td colspan="2">
