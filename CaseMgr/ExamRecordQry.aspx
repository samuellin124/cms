<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="ExamRecordQry.aspx.cs"
    Inherits="CaseMgr_ExamRecordQry" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>好消息熱線中心在線服務評核表</title>
...
<body class="body">
    <form id="Form1" runat="server" submitdisabledcontrols="False">
        ...
        <h1>
            <img src="../images/h1_arr.gif" alt="" width="10" height="10" />好消息熱線中心在線服務評核表</h1>
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" class="table_v">

            <tr>
                <th align="right" width="5%">志工姓名：</th>
